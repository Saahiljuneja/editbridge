...
import {
  ...
  IndianRupee, Zap, ChevronDown, ArrowDown,
} from "lucide-react";
        ...
        {FAQ.map(({ q }, i) => {
          ...
          return (
            <motion.button key={i} onClick={() => setActive(i)}
              ...
              {isActive && (
                <motion.div layoutId="faq-arrow" className="ml-auto shrink-0">
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="text-white/35 text-lg leading-relaxed mb-10 max-w-md">
                Clients pay a small 4% processing fee. Editors keep 85% of every order. No subscriptions. No hidden charges. Ever.
              </p>
            </Reveal>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <Reveal key={title} delay={i * 0.07}>
                <motion.div whileHover={{ y: -4, boxShadow: `0 16px 48px ${accent}14` }}
                  transition={{ type: "spring", stiffness: 260 }}
                  className="rounded-2xl border border-gray-100 bg-white p-6 h-full transition-all hover:border-gray-200">
