...
export default async function SavedPortfolioPage() {
                ...
                >
                  ...
                  {row.itemType === "video" ? (
                    <div className="absolute inset-0 bg-gray-900 flex items-center justify-center">
                      ...
                      <video src={proxyUrl} className="absolute inset-0 w-full h-full object-cover opacity-60" muted preload="metadata" />
                    </div>
                  ) : (
