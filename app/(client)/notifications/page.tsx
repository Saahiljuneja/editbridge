        ...
        {rows.length === 0 ? (
          ...
          <div className="rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
            {rows.map((n) => {
              ...
              const Icon = cfg.icon;
              return (
                <div key={n.id} className={cn("flex items-start gap-4 px-5 py-4 border-b border-gray-50 last:border-0", !n.isRead ? "bg-[#0EA5E9]/[0.02]" : "bg-white")}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-1.5">
                      ...
                      {n.link && <Link href={n.link} className="text-[10px] font-semibold text-[#0EA5E9] hover:underline">View →</Link>}
                    </div>
                  </div>
                </div>
              );
