      ...
      <div className="bg-white border-b border-gray-100 px-6 py-5">
        <div className="px-8 py-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Share EditBridge, earn ₹200 credits per referral</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { step: "3", title: "Both earn ₹200", desc: "When they place their first order, you both get ₹200 credits." },
            ].map(({ step, title, desc }) => (
              <div key={step} className="text-center">
                <div className="w-9 h-9 rounded-full bg-[#0EA5E9] text-white text-sm font-bold flex items-center justify-center mx-auto mb-3">
                  {step}
                </div>
        ...
        {data && (
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              { label: "Credits Earned", value: formatCurrency(data.totalEarned), icon: IndianRupee, color: "text-[#0EA5E9]", bg: "bg-[#0EA5E9]/5" },
