          ...
          <div className="space-y-4">
            {rows.map((review) => (
              <div key={review.id} className="rounded-2xl border border-gray-100 bg-white shadow-sm p-5">
                ...
                {review.replyText && (
                  <div className="mt-3 ml-4 border-l-2 border-[#0EA5E9]/20 pl-4">
                    <p className="text-xs font-semibold text-[#0EA5E9] mb-1">Editor replied</p>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-50">
                  ...
                  <Link href={`/orders/${review.orderId}`} className="text-xs font-medium text-[#0EA5E9] hover:underline">
                    View order
                  </Link>
                </div>
              </div>
