    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-8 py-6 space-y-5">
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: "Total spent", value: formatCurrency(totalSpent), icon: IndianRupee, color: "#0EA5E9" },
            { label: "Orders placed", value: String(txns.filter((t) => t.status !== "cancelled").length), icon: ShoppingBag, color: "#7C3AED" },
