    ...
    return (
      <div className="rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
        <div className="flex items-start gap-3 px-6 py-5 border-b border-gray-50">
          <div className="w-8 h-8 rounded-lg bg-[#0EA5E9]/10 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 text-sm pr-10 focus:outline-none focus:ring-2 focus:ring-[#0EA5E9]/20 focus:border-[#0EA5E9]/50"
                />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="text" inputMode="numeric" value={totp} onChange={(e) => setTotp(e.target.value.replace(/\D/g, "").slice(0, 6))}
                  ...
                  className="w-36 rounded-xl border border-gray-200 px-3.5 py-2.5 text-sm tracking-widest text-center focus:outline-none focus:ring-2 focus:ring-[#0EA5E9]/20" />
              </div>
