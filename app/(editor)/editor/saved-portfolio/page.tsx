    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-100">
        <div className="px-6 py-5 flex items-center justify-between">
          ...
          <div className="w-9 h-9 rounded-xl bg-[var(--brand-editor)]/10 flex items-center justify-center">
            <Bookmark className="w-4 h-4 text-[var(--brand-editor)]" />
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-6">
        {rows.length === 0 ? (
          <div className="rounded-2xl border border-gray-100 bg-white shadow-sm flex flex-col items-center justify-center py-20 text-center">
            <div className="w-14 h-14 rounded-2xl bg-[var(--brand-editor)]/10 flex items-center justify-center mb-4">
              <Bookmark className="w-7 h-7 text-[var(--brand-editor)]" />
            </div>
