  ...
  return (
    <div className="px-6 py-4 border-b border-gray-100">
      <p className="font-semibold text-gray-900 text-sm flex items-center gap-2">
        <span className="w-[3px] h-3.5 rounded-full bg-[#1e40af] shrink-0" />
        {title}
      </p>
...
function SaveButton({ loading, label = "Save changes" }: { loading: boolean; label?: string }) {
  return (
    <button
      type="submit"
      disabled={loading}
      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#1e40af] hover:bg-blue-900 disabled:opacity-50 transition-colors shadow-sm shadow-blue-200"
    >
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30"
            />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              maxLength={2000}
              rows={5}
              className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1e40af]/30 resize-none"
            />
        ...
        {step === "backup-codes" ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={finishSetup}
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-blue-900 transition-colors"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="000000"
                maxLength={6}
                className="rounded-xl border-gray-200 text-center font-mono tracking-widest focus-visible:ring-[#1e40af]/30"
              />
            </div>
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-blue-900 disabled:opacity-50 transition-colors"
              >
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={startSetup}
              disabled={busy}
              className="px-4 py-2 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-blue-900 disabled:opacity-50 transition-colors"
            >
      ...
      <Card>
        ...
        <form onSubmit={handleChangePassword} className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input type="password" value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} autoComplete="current-password" className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label className="text-sm font-medium text-gray-700">New password</Label>
              <Input type="password" value={newPassword} onChange={e => setNewPassword(e.target.value)} autoComplete="new-password" className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-sm font-medium text-gray-700">Confirm</Label>
              <Input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} autoComplete="new-password" className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30" />
            </div>
          </div>
...
function PaymentsTab() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl border border-blue-100 bg-blue-50 px-5 py-4 text-sm text-[#1e40af]">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                maxLength={11}
                className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30 font-mono"
              />
            </div>
          </div>
        ...
        <form onSubmit={handleSavePan} className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              maxLength={10}
              className="rounded-xl border-gray-200 focus-visible:ring-[#1e40af]/30 font-mono uppercase"
            />
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          {!showForm && (
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#1e40af] text-white text-xs font-semibold hover:bg-blue-900 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 border-b border-gray-100 bg-gray-50/50">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                maxLength={1000}
                rows={3}
                className="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1e40af]/30 resize-none"
              />
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    type="button"
                    onClick={() => startEdit(t)}
                    className="p-1.5 rounded-lg text-gray-300 hover:text-[#1e40af] hover:bg-blue-50/5 transition-colors"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 px-6 py-5 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#1e40af] via-blue-500 to-blue-400" />
          ...
          {TABS.map(tab => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.id
                  ? "border-[#1e40af] text-[#1e40af] bg-blue-50/60"
