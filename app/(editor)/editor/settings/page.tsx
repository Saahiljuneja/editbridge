...
import {
  ...
  ShoppingBag, RotateCcw, MessageSquare, Star, LogOut,
  Mail, Megaphone,
} from "lucide-react";
  ...
  return (
    <div className="px-6 py-4 border-b border-gray-100">
      <p className="font-semibold text-gray-900 text-sm flex items-center gap-2">
        <span className="w-[3px] h-3.5 rounded-full bg-[#7C3AED] shrink-0" />
        {title}
      </p>
      {desc && <p className="text-xs text-gray-400 mt-0.5 pl-[11px]">{desc}</p>}
    </div>
  );
}

function ToggleRow({ label, desc, value, onChange, icon: Icon }: { label: string; desc: string; value: boolean; onChange: (v: boolean) => void; icon?: React.ElementType }) {
  return (
...
function SaveButton({ loading, label = "Save changes" }: { loading: boolean; label?: string }) {
  return (
    <button
      type="submit"
      disabled={loading}
      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#7C3AED] hover:bg-violet-700 disabled:opacity-50 transition-colors shadow-sm shadow-violet-200"
    >
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30"
            />
          </div>
          <div className="space-y-1.5">
            <Label className="text-sm font-medium text-gray-700">
              Display name <span className="text-xs font-normal text-gray-400">(public)</span>
            </Label>
            <Input
              value={displayName}
              onChange={e => setDisplayName(e.target.value)}
              placeholder="e.g. Alex V. — leave blank to use your full name"
              maxLength={40}
              className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30"
            />
            <p className="text-xs text-gray-400">Shown on your public profile card instead of your full name</p>
          </div>
          <div className="space-y-1.5">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              maxLength={2000}
              rows={5}
              className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/30 resize-none"
            />
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30"
            />
            <p className="text-xs text-gray-400">Shown on your public profile</p>
          </div>
          <div className="space-y-1.5">
            <Label className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
        ...
        {step === "backup-codes" ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={finishSetup}
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#7C3AED] text-white text-sm font-semibold hover:bg-violet-700 transition-colors"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="000000"
                maxLength={6}
                className="rounded-xl border-gray-200 text-center font-mono tracking-widest focus-visible:ring-[#7C3AED]/30"
              />
            </div>
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#7C3AED] text-white text-sm font-semibold hover:bg-violet-700 disabled:opacity-50 transition-colors"
              >
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={startSetup}
              disabled={busy}
              className="px-4 py-2 rounded-xl bg-[#7C3AED] text-white text-sm font-semibold hover:bg-violet-700 disabled:opacity-50 transition-colors"
            >
  ...
  return (
    <div className="space-y-5">
      <Card>
        ...
        <form onSubmit={handleChangePassword} className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input type="password" value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} autoComplete="current-password" className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label className="text-sm font-medium text-gray-700">New password</Label>
              <Input type="password" value={newPassword} onChange={e => setNewPassword(e.target.value)} autoComplete="new-password" className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-sm font-medium text-gray-700">Confirm</Label>
              <Input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} autoComplete="new-password" className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30" />
            </div>
          </div>
      ...
      <button
        ...
        className="w-full rounded-2xl border border-gray-200 bg-white shadow-sm px-6 py-4 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center justify-between transition-colors group"
      >
        <span className="flex items-center gap-2.5">
          <LogOut className="w-4 h-4 text-gray-400 group-hover:text-gray-600 transition-colors" />
          Sign out of EditBridge
        </span>
...
function PaymentsTab() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl border border-violet-100 bg-violet-50 px-5 py-4 text-sm text-[#7C3AED]">
      ...
      <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4">
        <div className="flex items-center gap-2 mb-0.5">
          ...
          <p className="text-sm font-semibold text-amber-900">First payout hold — Razorpay new merchant policy</p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                maxLength={11}
                className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30 font-mono"
              />
            </div>
          </div>
        ...
        <form onSubmit={handleSavePan} className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              maxLength={10}
              className="rounded-xl border-gray-200 focus-visible:ring-[#7C3AED]/30 font-mono uppercase"
            />
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          {!showForm && (
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#7C3AED] text-white text-xs font-semibold hover:bg-violet-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 border-b border-gray-100 bg-gray-50/50">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                maxLength={1000}
                rows={3}
                className="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/30 resize-none"
              />
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    type="button"
                    onClick={() => startEdit(t)}
                    className="p-1.5 rounded-lg text-gray-300 hover:text-[#7C3AED] hover:bg-violet-50/5 transition-colors"
  ...
  return (
    <div className={cn("space-y-5", !loaded && "opacity-60 pointer-events-none")}>
      <Card>
        ...
        <ToggleRow icon={ShoppingBag} label="New order received"     desc="Email when a client places an order"        value={emailPrefs.newOrder}  onChange={v => setEmail("newOrder", v)} />
        <ToggleRow icon={RotateCcw}   label="Revision requested"     desc="Email when a client requests changes"       value={emailPrefs.revision}  onChange={v => setEmail("revision", v)} />
        <ToggleRow icon={Mail}        label="New message"            desc="Email when a client sends you a message"    value={emailPrefs.message}   onChange={v => setEmail("message", v)} />
        <ToggleRow icon={Megaphone}   label="Product updates & tips" desc="Occasional emails from the EditBridge team" value={emailPrefs.marketing} onChange={v => setEmail("marketing", v)} />
      </Card>

      <Card>
        <SectionHeader title="In-app notifications" desc="What appears in your notification bell" />
        <ToggleRow icon={ShoppingBag}  label="New order"          desc="When a client places an order"  value={notifPrefs.newOrder} onChange={v => setNotif("newOrder", v)} />
        <ToggleRow icon={RotateCcw}    label="Revision requested" desc="When a client requests changes" value={notifPrefs.revision} onChange={v => setNotif("revision", v)} />
        <ToggleRow icon={MessageSquare} label="New message"       desc="When a client sends a message"  value={notifPrefs.message}  onChange={v => setNotif("message", v)} />
        <ToggleRow icon={Star}         label="Review received"    desc="When a client leaves a review"  value={notifPrefs.review}   onChange={v => setNotif("review", v)} />
      </Card>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 px-6 py-5 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[#7C3AED] via-violet-400 to-violet-300" />
          ...
          {TABS.map(tab => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.id
                  ? "border-[#7C3AED] text-[#7C3AED] bg-violet-50/60"
