...
import { Bell, ShoppingBag, MessageSquare, Star, CheckCircle2, AlertCircle, Info, Megaphone, Heart, MessageCircle } from "lucide-react";
...
const TYPE_CONFIG: Record<string, { icon: React.ElementType; color: string; bg: string }> = {
  ...
  portfolio_like:       { icon: Heart,         color: "text-red-500",    bg: "bg-red-50" },
  portfolio_comment:    { icon: MessageCircle, color: "text-violet-600", bg: "bg-violet-50" },
