    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <textarea
          ...
          rows={5}
          maxLength={2000}
          className="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#0EA5E9]/20 focus:border-[#0EA5E9] resize-none"
        />
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0EA5E9] text-white text-sm font-semibold hover:bg-[#0a5a45] disabled:opacity-50 transition-colors"
          >
