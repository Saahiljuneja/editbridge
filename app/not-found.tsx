...
export default function NotFound() {
  return (
    ...
    >
      {/* Background blobs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[#0EA5E9]/15 blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-[#0F6E56]/10 blur-3xl pointer-events-none" />
