...
export default function ClientSignupPage() {
  ...
  // Read referral code from URL on mount, allow manual override
  ...
  return (
    <>
      ...
      <p className="text-sm text-gray-500 mb-6">Find and hire the best video editors</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="refCode">Referral code <span className="text-gray-400 font-normal">(optional)</span></Label>
          <Input
            id="refCode"
            name="refCode"
