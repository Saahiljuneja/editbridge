    ...
    <div className="w-full">
      ...
      <div className="flex flex-col items-center mb-4 text-center">
        ...
        <p className="text-[12.5px] text-neutral-400 font-semibold mb-3.5">
          Hire KYC-verified editors for your content.
        </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="relative rounded-[20px] border border-neutral-200 px-4 py-2.5 bg-[#ffffff] transition-all focus-within:ring-2 focus-within:ring-black/5 focus-within:border-black text-left">
          <label htmlFor="refCode" className="block text-[10px] font-bold text-neutral-400 uppercase tracking-wider select-none">
            Referral code <span className="text-neutral-300 font-normal">(optional)</span>
          </label>
          <input
            id="refCode"
            name="refCode"
