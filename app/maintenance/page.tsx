        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-[72px] h-[72px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <svg className="w-9 h-9" fill="none" viewBox="0 0 24 24" stroke="var(--brand-client)" strokeWidth={1.5}>
        ...
        {hasWindow && startFmt && endFmt && duration && (
          <div className="rounded-2xl mb-6 bg-white border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center px-6 py-6">
              ...
              {/* End */}
              <div className="flex-1 text-center">
                <p className="text-[11px] font-medium mb-1.5" style={{ color: "var(--brand-client)" }}>Back online</p>
                <p className="text-[26px] font-bold leading-none mb-1" style={{ color: "var(--brand-client)", letterSpacing: "-0.5px" }}>
                  {endFmt.digits}
                </p>
