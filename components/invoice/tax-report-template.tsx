...
const styles = StyleSheet.create({
  ...
  colNet: { width: "20%", fontSize: 9.5, fontFamily: "Helvetica-Bold", color: "#1e40af", textAlign: "right" },
  totalSection: {
    marginTop: 8,
    paddingTop: 10,
    borderTopWidth: 1.5,
  ...
  totalNet: { width: "20%", fontSize: 12, fontFamily: "Helvetica-Bold", color: "#1e40af", textAlign: "right" },
  footer: {
    position: "absolute",
    bottom: 32,
    left: 52,
